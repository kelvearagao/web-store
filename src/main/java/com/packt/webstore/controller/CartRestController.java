...
public class CartRestController {
	...
	public void update(@PathVariable(value = "cartId") String cartId, Cart cart) {
	...
	public @ResponseBody String getCartId(HttpServletRequest request) {
		...
		if (cart == null) {
			...
			System.out.println("Carrinho já existe! " + cart.getCartItems().size());
			cart = cartService.read(cart.getCartId());
			System.out.println("Preço " + cart.getGrandTotal());
		}
